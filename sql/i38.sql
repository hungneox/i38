...
--
-- Host: localhost    Database: bangtin
-- ------------------------------------------------------
...
CREATE TABLE `page` (
  ...
  `site_title` varchar(1024) COLLATE utf8_unicode_ci DEFAULT NULL,
  `site_url` varchar(2048) COLLATE utf8_unicode_ci NOT NULL,
